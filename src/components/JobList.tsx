      ...
      <section id="jobs" className="py-16">
        <div className="max-w-6xl mx-auto px-4">
          ...
          >
            ...
            <p className="text-gray-900 font-semibold text-lg mb-1">Erreur de chargement</p>
      ...
      <div className="max-w-6xl mx-auto px-4">
        ...
        >
          <div>
            <h2 className="text-2xl md:text-4xl font-bold text-gray-900">
              {hasActiveFilter ? "Résultats de recherche" : "Offres en remote"}
            </h2>
            <p className="text-gray-500 mt-1">
              {displayCount} résultat{displayCount > 1 ? "s" : ""} trouvé{displayCount > 1 ? "s" : ""}
            </p>
          </div>
        </motion.div>
        ...
        {displayCount === 0 ? (
          ...
          >
            ...
            <p className="text-gray-900 font-semibold text-lg mb-1">Aucune offre trouvée</p>
