        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-10">
          <div className="md:col-span-2">
            ...
            <p className="text-sm text-gray-500 max-w-sm leading-relaxed">
              JobFinder aggregates the best tech remote job offers.
              Find your next opportunity in one click.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#jobs" className="text-sm text-gray-400 hover:text-indigo-400 transition-colors">Jobs</a></li>
              <li><a href="#categories" className="text-sm text-gray-400 hover:text-indigo-400 transition-colors">Categories</a></li>
              <li><a href="#stats" className="text-sm text-gray-400 hover:text-indigo-400 transition-colors">Statistics</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-sm text-gray-400 hover:text-indigo-400 transition-colors">Privacy</a></li>
              <li><a href="#" className="text-sm text-gray-400 hover:text-indigo-400 transition-colors">Terms</a></li>
            </ul>
          </div>
        </div>
