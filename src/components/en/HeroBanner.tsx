...
const ROTATING_WORDS = ["dream", "future", "challenge", "passion", "mission"]
      ...
      <div className="relative max-w-6xl mx-auto px-4 py-28 w-full">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-gray-300 mb-8 max-w-xl leading-relaxed">
            Hundreds of remote jobs in web development, mobile, data & DevOps.
            One place for all tech remote opportunities.
          </p>
